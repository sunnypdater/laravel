...
<?php  foreach ($Symptom as $Symptom) { ?>
  <form action="/action_page.php">
    <label for="fname">ชื่อ : 
    <?php echo $Symptom->name; ?>
     </label><br>
    <label for="fname">รหัส : <?php echo $Symptom->id; ?> </label><br>
    <label for="fname">อาการ : <?php echo $Symptom->Symptom; ?> </label><br>
    <label for="fname">สถานะ : <?php echo $Symptom->Status; ?> </label><br>
